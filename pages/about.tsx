        ...
        <div className="w-screen">
            ...
            <div className="bg-red-100">
                <div className="w-full">
                    <h1 className="flex justify-center place-center my-20 opacity-75">About Us</h1>
                </div>
                <div className="w-full">
            ...
            <div>
                <div>
                    <div className="w-full">
                        <h1 className="flex justify-center place-center my-20 opacity-75">Who Are We</h1>
                    </div>
                </div>
            </div>
