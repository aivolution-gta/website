                            ...
                            <div className="col-span-1">
                                {teamData.map((data, index) => (
                                    <Accordion
                                        ...
                                        description={
                                            <div
                                                className={`grid grid-cols-1 text-center gap-4`}
                                            >
                                                {data.members.map(
                                                    (person, i) => (
                                                        <div
                                                            className="col-span-1 border-2 border-dark-purple rounded-md py-4 select-none transition-all ease-in-out hover:bg-dark-purple duration-300 hover:cursor-pointer hover:scale-105"
                                                            key={i}
                                                        >
                                                            <MuiModal
                                                                name={
